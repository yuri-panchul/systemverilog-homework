...
Под Ubuntu Linux можно установить Icarus Verilog и GTKWave с помощью команды:
...
После того, как тест для всех задачек покажет PASS
