...
Для успешного выполнения упражнения, необоримо на базовом уровне ознакомиться с представлением вещественных чисел (floating-point numbers) в компьютерах и в двоичном формате. Упражнение основывается на стандарте IEEE 754.
